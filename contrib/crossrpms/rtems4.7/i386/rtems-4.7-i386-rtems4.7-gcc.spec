...
Name:         	rtems-4.7-i386-rtems4.7-gcc
Summary:      	i386-rtems4.7 gcc
...
BuildRequires:	rtems-4.7-i386-rtems4.7-binutils

Requires:	rtems-4.7-gcc-common
Requires:	rtems-4.7-i386-rtems4.7-binutils
Requires:	rtems-4.7-i386-rtems4.7-newlib = %{newlib_version}-%{release}
...
# Misplaced header file
  if test -f $RPM_BUILD_ROOT%{_includedir}/mf-runtime.h; then
    mv $RPM_BUILD_ROOT%{_includedir}/mf-runtime.h \
      $RPM_BUILD_ROOT%{gcclib}/i386-rtems4.7/%{gcc_version}/include/
  fi
%endif
  ...
  rm -f $RPM_BUILD_ROOT%{_bindir}/i386-rtems4.7-c++filt%{_exeext}
...
%if "%{gcc_version}" >= "3.4"
  # Bug in gcc-3.4.0pre
  rm -f $RPM_BUILD_ROOT%{_bindir}/i386-rtems4.7-i386-rtems4.7-gcjh%{_exeext}
%endif

%if "%{gcc_version}" >= "3.3"
  # Bug in gcc-3.3.x/gcc-3.4.x: Despite we don't need fixincludes, it installs
  # the fixinclude-install-tools
  rm -rf ${RPM_BUILD_ROOT}%{gcclib}/i386-rtems4.7/%{gcc_version}/install-tools
  rm -rf ${RPM_BUILD_ROOT}%{gccexec}/i386-rtems4.7/%{gcc_version}/install-tools
%endif
  ...
  TGTDIR="%{_exec_prefix}/i386-rtems4.7/lib"
  for i in $f; do
    case $i in
...
%endif
  ...
  echo "%dir %{gcclib}/i386-rtems4.7" >> dirs

  TGTDIR="%{gcclib}/i386-rtems4.7/%{gcc_version}"
  for i in $f; do
    case $i in
...
#!/bin/sh
grep -E -v '^${RPM_BUILD_ROOT}%{_exec_prefix}/i386-rtems4.7/(lib|include|sys-root)' \
  | grep -v '^${RPM_BUILD_ROOT}%{gcclib}/i386-rtems4.7/' | %__find_provides
EOF
...
#!/bin/sh
grep -E -v '^${RPM_BUILD_ROOT}%{_exec_prefix}/i386-rtems4.7/(lib|include|sys-root)' \
  | grep -v '^${RPM_BUILD_ROOT}%{gcclib}/i386-rtems4.7/' | %__find_requires
EOF
...
# ==============================================================
# rtems-4.7-i386-rtems4.7-gcc
# ==============================================================
# %package -n rtems-4.7-i386-rtems4.7-gcc
# Summary:        GNU cc compiler for i386-rtems4.7
# Group:          Development/Tools
# Version:        %{gcc_rpmvers}
# Requires:       rtems-4.7-i386-rtems4.7-binutils
# Requires:       rtems-4.7-i386-rtems4.7-newlib = %{newlib_version}-%{release}
...
%description -n rtems-4.7-i386-rtems4.7-gcc
GNU cc compiler for i386-rtems4.7.

%files -n rtems-4.7-i386-rtems4.7-gcc -f build/files.gcc
%defattr(-,root,root)
%dir %{_mandir}
%dir %{_mandir}/man1
%{_mandir}/man1/i386-rtems4.7-gcc.1*
%if "%{gcc_version}" >= "3.4"
%{_mandir}/man1/i386-rtems4.7-cpp.1*
%{_mandir}/man1/i386-rtems4.7-gcov.1*
%endif

%dir %{_bindir}
%{_bindir}/i386-rtems4.7-cpp%{_exeext}
%{_bindir}/i386-rtems4.7-gcc%{_exeext}
%if "%{gcc_version}" >= "3.3"
%{_bindir}/i386-rtems4.7-gcc-%{gcc_version}%{_exeext}
%endif
%{_bindir}/i386-rtems4.7-gcov%{_exeext}
%{_bindir}/i386-rtems4.7-gccbug

%dir %{gcclib}/i386-rtems4.7/%{gcc_version}/include
%if "%{gcc_version}" > "4.0.3"
%if "i386-rtems4.7" != "bfin-rtems4.7"
%dir %{gcclib}/i386-rtems4.7/%{gcc_version}/include/ssp
%endif
%endif

%dir %{gccexec}
%dir %{gccexec}/i386-rtems4.7
%dir %{gccexec}/i386-rtems4.7/%{gcc_version}
%{gccexec}/i386-rtems4.7/%{gcc_version}/cc1%{_exeext}
%{gccexec}/i386-rtems4.7/%{gcc_version}/collect2%{_exeext}
...
# ==============================================================
# rtems-4.7-i386-rtems4.7-gcc-c++
# ==============================================================
%package -n rtems-4.7-i386-rtems4.7-gcc-c++
Summary:	GCC c++ compiler for i386-rtems4.7
Group:		Development/Tools
Version:        %{gcc_rpmvers}
License:	GPL

Provides:	rtems-4.7-i386-rtems4.7-c++ = %{gcc_rpmvers}-%{release}
Obsoletes:	rtems-4.7-i386-rtems4.7-c++ < %{gcc_rpmvers}-%{release}

Requires:       rtems-4.7-gcc-common
Requires:       rtems-4.7-i386-rtems4.7-gcc = %{gcc_rpmvers}-%{release}

%description -n rtems-4.7-i386-rtems4.7-gcc-c++
GCC c++ compiler for i386-rtems4.7.

%files -n rtems-4.7-i386-rtems4.7-gcc-c++ -f build/files.g++
%defattr(-,root,root)
%{_mandir}/man1/i386-rtems4.7-g++.1*

%{_bindir}/i386-rtems4.7-c++%{_exeext}
%{_bindir}/i386-rtems4.7-g++%{_exeext}

%dir %{gccexec}
%dir %{gccexec}/i386-rtems4.7
%dir %{gccexec}/i386-rtems4.7/%{gcc_version}
%{gccexec}/i386-rtems4.7/%{gcc_version}/cc1plus%{_exeext}

%dir %{gcclib}/i386-rtems4.7/%{gcc_version}/include
%if "%{gcc_version}" >= "3.2"
%{gcclib}/i386-rtems4.7/%{gcc_version}/include/c++
%else
%{gcclib}/i386-rtems4.7/%{gcc_version}/include/g++
%endif



# ==============================================================
# rtems-4.7-i386-rtems4.7-newlib
# ==============================================================
%package -n rtems-4.7-i386-rtems4.7-newlib
Summary:      	C Library (newlib) for i386-rtems4.7
Group: 		Development/Tools
License:	Distributable
Version:	%{newlib_version}

Provides:	rtems-4.7-i386-rtems4.7-libc = %{newlib_version}-%{release}
Obsoletes:	rtems-4.7-i386-rtems4.7-libc < %{newlib_version}-%{release}

Requires:	rtems-4.7-newlib-common

%description -n rtems-4.7-i386-rtems4.7-newlib
Newlib C Library for i386-rtems4.7.

%files -n rtems-4.7-i386-rtems4.7-newlib -f build/files.newlib
%defattr(-,root,root)
%dir %{_prefix}
%dir %{_exec_prefix}/i386-rtems4.7
%{_exec_prefix}/i386-rtems4.7/include
