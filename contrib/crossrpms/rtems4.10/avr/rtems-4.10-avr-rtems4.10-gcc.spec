...
Requires:	rtems-4.10-avr-rtems4.10-newlib = %{newlib_version}-66%{?dist}
...
Patch0:		ftp://ftp.rtems.org/pub/rtems/SOURCES/4.10/gcc-core-%{gcc_pkgvers}-rtems4.10-20091201.diff
%endif
...
echo "RTEMS gcc-%{gcc_version}-8%{?dist}\/newlib-%{newlib_version}-66%{?dist}" > gcc-%{gcc_pkgvers}/gcc/DEV-PHASE
