...
Requires:	rtems-4.10-powerpc-rtems4.10-newlib = %{newlib_version}-61%{?dist}
...
Patch0:		ftp://ftp.rtems.org/pub/rtems/SOURCES/4.10/gcc-core-%{gcc_pkgvers}-rtems4.10-20091015.diff
%endif
...
Patch50:	ftp://ftp.rtems.org/pub/rtems/SOURCES/4.10/newlib-1.17.0-rtems4.10-20091027.diff
%endif
