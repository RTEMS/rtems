...
Requires:	rtems-4.10-powerpc-rtems4.10-newlib = %{newlib_version}-6%{?dist}
...
echo "RTEMS gcc-%{gcc_version}-5%{?dist}/newlib-%{newlib_version}-6%{?dist}" > gcc-%{gcc_pkgvers}/gcc/DEV-PHASE
