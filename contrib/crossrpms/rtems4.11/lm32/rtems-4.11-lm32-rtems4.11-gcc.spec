...
Requires:	rtems-4.11-lm32-rtems4.11-newlib = %{newlib_version}-27%{?dist}
...
echo "RTEMS gcc-%{gcc_version}-20%{?dist}/newlib-%{newlib_version}-27%{?dist}" > gcc-%{gcc_pkgvers}/gcc/DEV-PHASE
