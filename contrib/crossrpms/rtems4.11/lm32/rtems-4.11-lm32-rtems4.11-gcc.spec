...
Requires:	rtems-4.11-lm32-rtems4.11-newlib = %{newlib_version}-23%{?dist}
...
Patch50:	ftp://ftp.rtems.org/pub/rtems/SOURCES/4.11/newlib-1.18.0-rtems4.11-20101006.diff
%endif
...
echo "RTEMS gcc-%{gcc_version}-8%{?dist}/newlib-%{newlib_version}-23%{?dist}" > gcc-%{gcc_pkgvers}/gcc/DEV-PHASE
