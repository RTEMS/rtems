...
# Misplaced header file
  if test -f $RPM_BUILD_ROOT%{_includedir}/mf-runtime.h; then
    mv $RPM_BUILD_ROOT%{_includedir}/mf-runtime.h \
      $RPM_BUILD_ROOT%{gcclib}/i586-pc-freebsd6.4/%{gcc_version}/include/
  fi
%endif
...
#  # Bug in gcc-4.0.0pre
#  mv $RPM_BUILD_ROOT%{_bindir}/gfortran $RPM_BUILD_ROOT%{_bindir}/i586-pc-freebsd6.4-gfortran
...
%if "%{gcc_version}" >= "3.3"
  ...
  rm -rf ${RPM_BUILD_ROOT}%{gcclib}/i586-pc-freebsd6.4/%{gcc_version}/install-tools
  rm -rf ${RPM_BUILD_ROOT}%{gccexec}/i586-pc-freebsd6.4/%{gcc_version}/install-tools
%endif
  ...
  echo "%dir %{gcclib}/i586-pc-freebsd6.4" >> dirs

  TGTDIR="%{gcclib}/i586-pc-freebsd6.4/%{gcc_version}"
  for i in $f; do
    case $i in
...
%files -n i586-pc-freebsd6.4-gcc -f build/files.gcc
%defattr(-,root,root)
...
%dir %{gcclib}/i586-pc-freebsd6.4/%{gcc_version}/include
%if "%{gcc_version}" > "4.0.3"
%if "i586-pc-freebsd6.4" != "bfin-rtems4.10"
%if "i586-pc-freebsd6.4" != "avr-rtems4.10"
%dir %{gcclib}/i586-pc-freebsd6.4/%{gcc_version}/include/ssp
%endif
%endif
%endif

%if "%{gcc_version}" >= "4.3.0"
%dir %{gcclib}/i586-pc-freebsd6.4/%{gcc_version}/include-fixed
%endif

%dir %{gccexec}
%dir %{gccexec}/i586-pc-freebsd6.4
%dir %{gccexec}/i586-pc-freebsd6.4/%{gcc_version}
%{gccexec}/i586-pc-freebsd6.4/%{gcc_version}/cc1%{_exeext}
%{gccexec}/i586-pc-freebsd6.4/%{gcc_version}/collect2%{_exeext}
...
%endif
Provides:	i586-pc-freebsd6.4-c++ = %{gcc_rpmvers}-%{release}
Obsoletes:	i586-pc-freebsd6.4-c++ < %{gcc_rpmvers}-%{release}
...
%files -n i586-pc-freebsd6.4-gcc-c++ -f build/files.g++
%defattr(-,root,root)
...
%dir %{gccexec}/i586-pc-freebsd6.4
%dir %{gccexec}/i586-pc-freebsd6.4/%{gcc_version}
%{gccexec}/i586-pc-freebsd6.4/%{gcc_version}/cc1plus%{_exeext}

%dir %{gcclib}/i586-pc-freebsd6.4/%{gcc_version}/include
%{gcclib}/i586-pc-freebsd6.4/%{gcc_version}/include/c++
...
Provides:	i586-pc-freebsd6.4-gfortran = %{gcc_rpmvers}-%{release}
Obsoletes:	i586-pc-freebsd6.4-gfortran < %{gcc_rpmvers}-%{release}

Requires:       i586-pc-freebsd6.4-gcc = %{gcc_rpmvers}-%{release}
Obsoletes:      i586-pc-freebsd6.4-g77 < %{gcc_rpmvers}-%{release}

%description -n i586-pc-freebsd6.4-gcc-gfortran
GCC fortran compiler for i586-pc-freebsd6.4.

%files -n i586-pc-freebsd6.4-gcc-gfortran -f build/files.gfortran
%defattr(-,root,root)
...
%dir %{gccexec}/i586-pc-freebsd6.4
%dir %{gccexec}/i586-pc-freebsd6.4/%{gcc_version}
%{gccexec}/i586-pc-freebsd6.4/%{gcc_version}/f951%{_exeext}
...
Version:        %{gcc_rpmvers}
License:	GPL
Provides:	i586-pc-freebsd6.4-objc = %{gcc_rpmvers}-%{release}
Obsoletes:	i586-pc-freebsd6.4-objc < %{gcc_rpmvers}-%{release}
...
%files -n i586-pc-freebsd6.4-gcc-objc -f build/files.objc
%defattr(-,root,root)

%dir %{gccexec}
%dir %{gccexec}/i586-pc-freebsd6.4
%dir %{gccexec}/i586-pc-freebsd6.4/%{gcc_version}
%{gccexec}/i586-pc-freebsd6.4/%{gcc_version}/cc1obj%{_exeext}

%{gcclib}/i586-pc-freebsd6.4/%{gcc_version}/include/objc
