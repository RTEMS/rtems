...
Name:		rtems-4.8-i386-rtems4.8-binutils
...
%description
Cross binutils for target i386-rtems4.8
%prep
...
# manpages without corresponding tools
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/i386-rtems4.8-dlltool%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/i386-rtems4.8-dlltool*
  fi
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/i386-rtems4.8-nlmconv%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/i386-rtems4.8-nlmconv*
  fi
...
# ==============================================================
# i386-rtems4.8-binutils
# ==============================================================
# %package -n rtems-4.8-i386-rtems4.8-binutils
# Summary:      rtems binutils for i386-rtems4.8
# Group: Development/Tools
# %if %build_infos
# Requires: rtems-4.8-binutils-common
# %endif
...
%dir %{_exec_prefix}/i386-rtems4.8/bin
%{_exec_prefix}/i386-rtems4.8/bin/*

%dir %{_exec_prefix}/i386-rtems4.8/lib
%{_exec_prefix}/i386-rtems4.8/lib/ldscripts
# ==============================================================
