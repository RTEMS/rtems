...
Name:		rtems-4.8-tic4x-rtems4.8-binutils
Summary:	Binutils for target tic4x-rtems4.8
...
%description
Cross binutils for target tic4x-rtems4.8
%prep
...
%build
%if "tic4x-rtems4.8" == "i686-pc-cygwin"
...
# manpages without corresponding tools
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/tic4x-rtems4.8-dlltool%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/tic4x-rtems4.8-dlltool*
  fi
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/tic4x-rtems4.8-nlmconv%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/tic4x-rtems4.8-nlmconv*
  fi
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/tic4x-rtems4.8-windres%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/tic4x-rtems4.8-windres*
  fi
...
# ==============================================================
# tic4x-rtems4.8-binutils
# ==============================================================
# %package -n rtems-4.8-tic4x-rtems4.8-binutils
# Summary:      rtems binutils for tic4x-rtems4.8
# Group: Development/Tools
# %if %build_infos
# Requires: rtems-4.8-binutils-common
# %endif

%description -n rtems-4.8-tic4x-rtems4.8-binutils

GNU binutils targetting tic4x-rtems4.8.

%files -n rtems-4.8-tic4x-rtems4.8-binutils
%defattr(-,root,root)
%dir %{_mandir}
%dir %{_mandir}/man1
%{_mandir}/man1/tic4x-rtems4.8-*.1*

%dir %{_bindir}
%{_bindir}/tic4x-rtems4.8-*

%dir %{_exec_prefix}/tic4x-rtems4.8
%dir %{_exec_prefix}/tic4x-rtems4.8/bin
%{_exec_prefix}/tic4x-rtems4.8/bin/*

%dir %{_exec_prefix}/tic4x-rtems4.8/lib
%{_exec_prefix}/tic4x-rtems4.8/lib/ldscripts
# ==============================================================
