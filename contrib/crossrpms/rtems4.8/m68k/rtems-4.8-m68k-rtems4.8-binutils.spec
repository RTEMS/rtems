...
Name:		rtems-4.8-m68k-rtems4.8-binutils
...
%description
Cross binutils for target m68k-rtems4.8
%prep
...
# manpages without corresponding tools
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/m68k-rtems4.8-dlltool%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/m68k-rtems4.8-dlltool*
  fi
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/m68k-rtems4.8-nlmconv%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/m68k-rtems4.8-nlmconv*
  fi
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/m68k-rtems4.8-windres%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/m68k-rtems4.8-windres*
  fi
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/m68k-rtems4.8-windmc%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/m68k-rtems4.8-windmc*
  fi
...
# ==============================================================
# m68k-rtems4.8-binutils
# ==============================================================
# %package -n rtems-4.8-m68k-rtems4.8-binutils
# Summary:      rtems binutils for m68k-rtems4.8
# Group: Development/Tools
# %if %build_infos
# Requires: rtems-4.8-binutils-common
# %endif
...
%dir %{_exec_prefix}/m68k-rtems4.8/bin
%{_exec_prefix}/m68k-rtems4.8/bin/*

%dir %{_exec_prefix}/m68k-rtems4.8/lib
%{_exec_prefix}/m68k-rtems4.8/lib/ldscripts
# ==============================================================
