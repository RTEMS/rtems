...
%description
Cross binutils for target avr-rtems4.8
%prep
...
%build
%if "avr-rtems4.8" == "i686-pc-cygwin"
...
# manpages without corresponding tools
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/avr-rtems4.8-dlltool%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/avr-rtems4.8-dlltool*
  fi
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/avr-rtems4.8-nlmconv%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/avr-rtems4.8-nlmconv*
  fi
  if test ! -f ${RPM_BUILD_ROOT}%{_bindir}/avr-rtems4.8-windres%{_exeext}; then 
    rm -f ${RPM_BUILD_ROOT}%{_mandir}/man1/avr-rtems4.8-windres*
  fi
...
# ==============================================================
# avr-rtems4.8-binutils
# ==============================================================
# %package -n rtems-4.8-avr-rtems4.8-binutils
# Summary:      rtems binutils for avr-rtems4.8
# Group: Development/Tools
# %if %build_infos
# Requires: rtems-4.8-binutils-common
# %endif

%description -n rtems-4.8-avr-rtems4.8-binutils

GNU binutils targetting avr-rtems4.8.

%files -n rtems-4.8-avr-rtems4.8-binutils
%defattr(-,root,root)
%dir %{_mandir}
%dir %{_mandir}/man1
...
%dir %{_exec_prefix}/avr-rtems4.8/bin
%{_exec_prefix}/avr-rtems4.8/bin/*

%dir %{_exec_prefix}/avr-rtems4.8/lib
%{_exec_prefix}/avr-rtems4.8/lib/ldscripts
# ==============================================================
