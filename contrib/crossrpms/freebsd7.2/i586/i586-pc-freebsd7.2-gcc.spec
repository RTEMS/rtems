...
# Misplaced header file
  if test -f $RPM_BUILD_ROOT%{_includedir}/mf-runtime.h; then
    mv $RPM_BUILD_ROOT%{_includedir}/mf-runtime.h \
      $RPM_BUILD_ROOT%{_gcclibdir}/gcc/i586-pc-freebsd7.2/%{gcc_version}/include/
  fi
%endif
...
# Conflict with a native GCC's man pages
  ...
  rm -rf ${RPM_BUILD_ROOT}%{_gcclibdir}/gcc/i586-pc-freebsd7.2/%{gcc_version}/install-tools
  rm -rf ${RPM_BUILD_ROOT}%{_libexecdir}/gcc/i586-pc-freebsd7.2/%{gcc_version}/install-tools
...
%if "%{gcc_version}" >= "4.5.0"
%{?with_lto:%{_libexecdir}/gcc/i586-pc-freebsd7.2/%{gcc_version}/lto%{_exeext}}
%{_libexecdir}/gcc/i586-pc-freebsd7.2/%{gcc_version}/lto-wrapper%{_exeext}
%endif
...
%dir %{_gcclibdir}/gcc/i586-pc-freebsd7.2/%{gcc_version}/include/ssp
%endif
