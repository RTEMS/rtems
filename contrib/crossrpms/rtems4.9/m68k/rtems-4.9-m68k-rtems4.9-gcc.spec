...
Requires:	rtems-4.9-m68k-rtems4.9-newlib = %{newlib_version}-%{release}
...
# ==============================================================
# rtems-4.9-m68k-rtems4.9-gcc
# ==============================================================
# %package -n rtems-4.9-m68k-rtems4.9-gcc
# Summary:        GNU cc compiler for m68k-rtems4.9
# Group:          Development/Tools
# Version:        %{gcc_rpmvers}
# Requires:       rtems-4.9-m68k-rtems4.9-binutils
# Requires:       rtems-4.9-m68k-rtems4.9-newlib = %{newlib_version}-%{release}
...
%else
%{gcclib}/m68k-rtems4.9/%{gcc_version}/include/g++
%endif
...
Provides:	rtems-4.9-m68k-rtems4.9-libc = %{newlib_version}-%{release}
Obsoletes:	rtems-4.9-m68k-rtems4.9-libc < %{newlib_version}-%{release}
