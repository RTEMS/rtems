...
Requires:	rtems-4.9-i386-rtems4.9-newlib = %{newlib_version}-%{release}
...
%if "%{gcc_version}" > "4.0.3"
%if "i386-rtems4.9" != "bfin-rtems4.8"
...
%else
%{gcclib}/i386-rtems4.9/%{gcc_version}/include/g++
%endif
...
Provides:	rtems-4.9-i386-rtems4.9-libc = %{newlib_version}-%{release}
Obsoletes:	rtems-4.9-i386-rtems4.9-libc < %{newlib_version}-%{release}
