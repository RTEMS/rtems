...
Requires:	rtems-4.9-bfin-rtems4.9-newlib = %{newlib_version}-%{release}
...
# ==============================================================
# %package -n rtems-4.9-bfin-rtems4.9-gcc
...
Provides:	rtems-4.9-bfin-rtems4.9-libc = %{newlib_version}-%{release}
Obsoletes:	rtems-4.9-bfin-rtems4.9-libc < %{newlib_version}-%{release}
