...
Requires:	rtems-4.9-avr-rtems4.9-newlib = %{newlib_version}-%{release}
...
Provides:	rtems-4.9-avr-rtems4.9-libc = %{newlib_version}-%{release}
Obsoletes:	rtems-4.9-avr-rtems4.9-libc < %{newlib_version}-%{release}
