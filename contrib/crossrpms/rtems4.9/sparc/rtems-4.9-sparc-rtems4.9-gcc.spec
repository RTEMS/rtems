...
Requires:	rtems-4.9-sparc-rtems4.9-newlib = %{newlib_version}-%{release}
...
%install
  ...
  cd build/sparc-rtems4.9/newlib
...
%if "%{gcc_version}" > "4.0.3"
%if "sparc-rtems4.9" != "bfin-rtems4.8"
...
# ==============================================================
# rtems-4.9-sparc-rtems4.9-gcc-c++
# ==============================================================
%package -n rtems-4.9-sparc-rtems4.9-gcc-c++
Summary:	GCC c++ compiler for sparc-rtems4.9
Group:		Development/Tools
Version:        %{gcc_rpmvers}
License:	GPL
...
%else
%{gcclib}/sparc-rtems4.9/%{gcc_version}/include/g++
%endif



# ==============================================================
# rtems-4.9-sparc-rtems4.9-newlib
# ==============================================================
%package -n rtems-4.9-sparc-rtems4.9-newlib
Summary:      	C Library (newlib) for sparc-rtems4.9
Group: 		Development/Tools
License:	Distributable
Version:	%{newlib_version}

Provides:	rtems-4.9-sparc-rtems4.9-libc = %{newlib_version}-%{release}
Obsoletes:	rtems-4.9-sparc-rtems4.9-libc < %{newlib_version}-%{release}
