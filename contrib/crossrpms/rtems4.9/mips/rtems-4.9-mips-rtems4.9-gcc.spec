...
Requires:	rtems-4.9-mips-rtems4.9-newlib = %{newlib_version}-%{release}
...
%if "%{gcc_version}" > "4.0.3"
%if "mips-rtems4.9" != "bfin-rtems4.8"
...
# ==============================================================
# rtems-4.9-mips-rtems4.9-gcc-c++
# ==============================================================
%package -n rtems-4.9-mips-rtems4.9-gcc-c++
Summary:	GCC c++ compiler for mips-rtems4.9
Group:		Development/Tools
Version:        %{gcc_rpmvers}
License:	GPL
...
%else
%{gcclib}/mips-rtems4.9/%{gcc_version}/include/g++
%endif



# ==============================================================
# rtems-4.9-mips-rtems4.9-newlib
# ==============================================================
%package -n rtems-4.9-mips-rtems4.9-newlib
Summary:      	C Library (newlib) for mips-rtems4.9
Group: 		Development/Tools
License:	Distributable
Version:	%{newlib_version}

Provides:	rtems-4.9-mips-rtems4.9-libc = %{newlib_version}-%{release}
Obsoletes:	rtems-4.9-mips-rtems4.9-libc < %{newlib_version}-%{release}
