...
Requires:	rtems-4.9-arm-rtems4.9-newlib = %{newlib_version}-%{release}
...
# ==============================================================
%package -n rtems-4.9-arm-rtems4.9-gcc-c++
Summary:	GCC c++ compiler for arm-rtems4.9
Group:		Development/Tools
Version:        %{gcc_rpmvers}
License:	GPL
...
%else
%{gcclib}/arm-rtems4.9/%{gcc_version}/include/g++
%endif
...
Provides:	rtems-4.9-arm-rtems4.9-libc = %{newlib_version}-%{release}
Obsoletes:	rtems-4.9-arm-rtems4.9-libc < %{newlib_version}-%{release}
