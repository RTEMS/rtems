...
Requires:	rtems-4.9-sh-rtems4.9-newlib = %{newlib_version}-%{release}
...
%else
%{gcclib}/sh-rtems4.9/%{gcc_version}/include/g++
%endif
...
Provides:	rtems-4.9-sh-rtems4.9-libc = %{newlib_version}-%{release}
Obsoletes:	rtems-4.9-sh-rtems4.9-libc < %{newlib_version}-%{release}
