...
/*
 * Under PCI0, each device has 256 bytes of configuration address space,
...
#define  PCI_COMMAND_SB_DIS     0x2000  /* PCI configuration read will stop
                                         ...
                                         */ 
#define PCI0_STATUS		0x06	/* 16 bits */
 ...
 * 1 bits are decoded.
 */
#define PCI0_BASE_ADDRESS_0	0x10	/* 32 bits */
#define PCI0_BASE_ADDRESS_1	0x14	/* 32 bits [htype 0,1 only] */
#define PCI0_BASE_ADDRESS_2	0x18	/* 32 bits [htype 0 only] */
#define PCI0_BASE_ADDRESS_3	0x1c	/* 32 bits */
#define PCI0_MEM_BASE_ADDR	0x20	/* 32 bits */
#define PCI0_IO_BASE_ADDR	0x24	/* 32 bits */
...
#define PCI0_CARDBUS_CIS		0x28
#define PCI0_SUBSYSTEM_VENDOR_ID	0x2c
#define PCI0_SUBSYSTEM_ID	        0x2e  
#define PCI0_ROM_ADDRESS		0x30	/* Bits 31..11 are address, 10..1 reserved */
...
extern pci_config BSP_pci_config[2];
...
extern int pci_read_config_byte(unsigned char bus, unsigned char dev,unsigned char func,unsigned char offset,unsigned char *val);
extern int pci_read_config_word(unsigned char bus, unsigned char dev,unsigned char func, unsigned char offset, unsigned short *val);
extern int pci_read_config_dword(unsigned char bus, unsigned char dev,unsigned char func, unsigned char offset, unsigned int *val);
