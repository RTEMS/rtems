...
#define BEAGLE_UART5_RHR = BAGLE_BASE_UART5 + BEAGLE_UART_BEAGLE_UART_RHR_REG_OFFSET
...
#define BEAGLE_UART5_XON1_ADDR1 = BAGLE_BASE_UART5 + BEAGLE_UART_XON1_ADDR1_REG_OFFSET
#define BEAGLE_UART5_LSR = BAGLE_BASE_UART5 + BEAGLE_UART_LSR_REG_OFFSET
#define BEAGLE_UART5_XON2_ADDR2 = BAGLE_BASE_UART5 + BEAGLE_UART_XON2_ADDR2_REG_OFFSET
