...
static inline bool beagle_irq_is_bit_set_in_register(unsigned index, unsigned register_offset)
{
...
static inline void beagle_irq_set_bit_in_register(unsigned index, unsigned register_offset)
{
...
static inline void beagle_irq_clear_bit_in_register(unsigned index, unsigned register_offset)
{
...
static inline void beagle_irq_set_bit_in_field(unsigned index, beagle_irq_fields *fields)
{
...
static inline void beagle_irq_clear_bit_in_field(unsigned index, beagle_irq_fields *fields)
{
