...
#define ATOMIC_FETCH_SUB_NO_BARRIER(TYPE, cpuid)         \
{                                                        \
    ...
    )
{
  ...
  ATOMIC_FETCH_SUB_NO_BARRIER(int, cpu_num);

  ATOMIC_FETCH_SUB_NO_BARRIER(long, cpu_num);

  ATOMIC_FETCH_SUB_NO_BARRIER(ptr, cpu_num);

  ATOMIC_FETCH_SUB_NO_BARRIER(32, cpu_num);
