    ...
    )
{
  ...
  ATOMIC_STORE_NO_BARRIER(Pointer, cpu_num, ATOMIC_RELAXED_BARRIER);

  ATOMIC_STORE_NO_BARRIER(Int32, cpu_num, ATOMIC_RELAXED_BARRIER);
  ...
  ATOMIC_STORE_NO_BARRIER(Pointer, cpu_num, ATOMIC_RELEASE_BARRIER);

  ATOMIC_STORE_NO_BARRIER(Int32, cpu_num, ATOMIC_RELEASE_BARRIER);
