    ...
    )
{
  ...
  ATOMIC_FETCH_ADD_NO_BARRIER(ptr, cpu_num, ATOMIC_RELAXED_BARRIER);

  ATOMIC_FETCH_ADD_NO_BARRIER(32, cpu_num, ATOMIC_RELAXED_BARRIER);
  ...
  ATOMIC_FETCH_ADD_NO_BARRIER(ptr, cpu_num, ATOMIC_ACQUIRE_BARRIER);

  ATOMIC_FETCH_ADD_NO_BARRIER(32, cpu_num, ATOMIC_ACQUIRE_BARRIER);
  ...
  ATOMIC_FETCH_ADD_NO_BARRIER(ptr, cpu_num, ATOMIC_RELEASE_BARRIER);

  ATOMIC_FETCH_ADD_NO_BARRIER(32, cpu_num, ATOMIC_RELEASE_BARRIER);
