/*
 * This is a copy of the zynqmp dtb for testing. It was copied from
 * bsps/aarch64/xilinx-zynqmp/fdt/zynqmp_dtb.c
 */

#ifndef __zynqmp_test_dtb_h
#define __zynqmp_test_dtb_h

#include <rtems/score/basedefs.h>
#include <sys/types.h>

const unsigned char zynqmp_test_dtb[] RTEMS_ALIGNED(8) = {
...
const size_t zynqmp_test_dtb_size = sizeof(zynqmp_test_dtb);

#endif /* __zynqmp_test_dtb_h */
